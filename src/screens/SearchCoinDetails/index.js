    ...
    const getDetails = async () => {
      try {
        ...
        const result = await axios.get(
          `${config.REACT_APP_COIN_BASE_URL}/api/v3/coins/markets?vs_currency=${appCurrency.ticker}&ids=${coinId}&order=market_cap_desc&per_page=1&page=1&sparkline=true&price_change_percentage=24h`,
        );
              ...
              <View
                ...
                <CoinDetailsTitle
                  ...
                  priceChangePercentage24h={
                    fullDetails?.price_change_percentage_24h
                  }
                />
                <CoinDetailsChart
                  chartPrices={fullDetails?.sparkline_in_7d?.price?.map(
                ...
                <Text
                  ...
                  Updated: {moment(fullDetails.last_updated).fromNow()}
                </Text>
                <View
                  style={[
                  ...
                  <Text
                    style={[styles.coinDetails, {color: appTheme.textColor}]}>
                    Coin Details
                  </Text>
                  <CoinDetailsInfo
                    title={'MARKET CAP'}
                    value={
                      appCurrency.symbol +
                      ' ' +
                      fullDetails?.market_cap?.toLocaleString('en-US')
                    }
                  />
                  <CoinDetailsInfo
                    ...
                    value={
                      appCurrency.symbol +
                      ' ' +
                      fullDetails?.total_volume?.toLocaleString('en-US')
                    }
                  />
                  <CoinDetailsInfo
                    title={'24HR HIGH'}
                    value={
                      appCurrency.symbol +
                      ' ' +
                      fullDetails?.high_24h?.toLocaleString('en-US')
                    }
                  />
                  <CoinDetailsInfo
                    title={'24HR LOW'}
                    value={
                      appCurrency.symbol +
                      ' ' +
                      fullDetails?.low_24h?.toLocaleString('en-US')
                    }
                  />
                  <CoinDetailsInfo
                    title={'ALL TIME HIGH'}
                    value={
                      appCurrency.symbol +
                      ' ' +
                      fullDetails?.ath?.toLocaleString('en-US')
                    }
                  />
                  <CoinDetailsInfo
                  ...
                  <CoinDetailsInfo
                    ...
                    value={
                      appCurrency.symbol +
                      ' ' +
                      fullDetails?.atl?.toLocaleString('en-US')
                    }
                  />
                  <CoinDetailsInfo
                  ...
                  <CoinDetailsInfo
                    ...
                    value={
                      appCurrency.symbol +
                      ' ' +
                      fullDetails?.circulating_supply?.toLocaleString('en-US')
                    }
                  />
                  <CoinDetailsInfo
                    title={'TOTAL SUPPLY'}
                    value={
                      appCurrency.symbol +
                      ' ' +
                      fullDetails?.total_supply?.toLocaleString('en-US')
                    }
                  />
                </View>
                <View style={styles.converterContainer}>
                  <Text
                    style={[styles.convertCoin, {color: appTheme.textColor}]}>
                    Convert Coin
                  </Text>
                  ...
                  <View
                    ...
                    <View
                      ...
                      <Image
                        ...
                        source={
                          swap ? {uri: fullDetails.image} : appCurrency.image
                        }
                      />

                      <Text style={{color: appTheme.textColor, ...FONTS.body7}}>
                        {swap
                          ? fullDetails?.symbol?.toUpperCase()
                          : appCurrency.ticker}
                      </Text>
                    </View>

                    <TouchableOpacity
                      onPress={() => setSwap(prevState => !prevState)}
                      style={{
                        width: 44,
                        height: 44,
                    ...
                    <View
                      ...
                      <Image
                        ...
                        source={
                          swap ? appCurrency.image : {uri: fullDetails.image}
                        }
                      />
                      <Text style={{color: appTheme.textColor, ...FONTS.body7}}>
                        {swap
