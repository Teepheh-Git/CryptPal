  ...
  return coinTrend.length < 0 ? (
    <View
      ...
      {appTheme.name === 'light' ? (
        <LottieView
          style={{width: 80, height: 80}}
          source={require('../../assets/images/pupr.mp4.lottie.json')}
          autoPlay
          loop
        />
      ) : (
        <LottieView
          style={{width: 80, height: 80}}
          source={require('../../assets/images/black.mp4.lottie.json')}
          autoPlay
          loop
        />
      )}
      ...
      <ScrollView
        ...
        {constants.listTab.map((buttonLabel, index) => (
          <TouchableOpacity
            ...
            style={[
              styles.btnTab,
              tabStatus === buttonLabel.tabStatus && styles.btnTabActive,
            ]}
            onPress={() => setTabStatusFilter(buttonLabel.tabStatus)}>
            <Text
              style={[
                styles.textTab,
                tabStatus === buttonLabel.status && styles.textTabActive,
              ]}>
