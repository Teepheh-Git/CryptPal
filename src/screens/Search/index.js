  ...
  const Search = async () => {
    try {
      const res = await axios.get(
        `https://api.coingecko.com/api/v3/search?query=${coinSearch}`,
      );
      ...
      <Animatable.View
        ...
        <TouchableOpacity
          ...
          <View style={styles.textContainer}>
            ...
            <Text style={[styles.rank, {color: appTheme.textColor3}]}>
  ...
  const AboutToSearch = () => {
    return (
      <Animatable.View
        ...
        />
        <Text
          style={{...FONTS.h7, color: appTheme.textColor, marginVertical: 5}}>
        ...
        <Text
          ...
          Sorry, you'll have to make a search to get any result here.
        </Text>
      </Animatable.View>
    );
  };
    ...
    return (
      <Animatable.View
        ...
        <Text
          ...
          Sorry, we couldn't find any result in our database
        </Text>
      </Animatable.View>
    );
  };
