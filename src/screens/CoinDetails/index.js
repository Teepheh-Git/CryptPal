              ...
              <View style={styles.converterContainer}>
                ...
                <View style={{
                  ...
                  <View style={{
                    ...
                    <Text
                      style={{ color: appTheme.textColor, ...FONTS.body7 }}>{swap ? dataFromHome.symbol.toUpperCase() : appCurrency.ticker}</Text>
                  ...
                  <View style={{
                    ...
                    <Text
                      style={{ color: appTheme.textColor, ...FONTS.body7 }}>{swap ? appCurrency.ticker : dataFromHome.symbol.toUpperCase()}</Text>
